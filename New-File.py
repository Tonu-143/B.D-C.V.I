...
{B} [{R}✔{B}] {Y}DEVELOPER  :{G}  BD-TERMUX

{B} [{R}✔{B}] {B}FACEBOOK   :{G} MEHEDI HASAN TONU

{B} [{R}✔{B}] {nb}WHATSAPP   :{G} +8801759916221
...
def fb():
    ...
    s("xdg-open https://www.facebook.com/SADHARON.USER.143")

def git():

    s(" os.system('xdg-open https://github.com/Tonu-143")

def git():

    s("xdg-open https://github.com/Tonu-143")
